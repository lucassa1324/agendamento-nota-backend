...
export const user = pgTable("user", {
	...
	notifyNewAppointments: boolean("notify_new_appointments")
		.default(true)
		.notNull(),
	notifyCancellations: boolean("notify_cancellations").default(true).notNull(),
	notifyInventoryAlerts: boolean("notify_inventory_alerts")
		.default(true)
		.notNull(),
...
export const companySiteCustomizations = pgTable(
	"company_site_customizations",
	{
		...
		companyId: text("company_id")
			...
			.unique()
			.references(() => companies.id, { onDelete: "cascade" }),
		layoutGlobal: jsonb("layout_global")
			.default(DEFAULT_LAYOUT_GLOBAL)
			.notNull(),
...
export const appointments = pgTable("appointments", {
	...
	servicePriceSnapshot: numeric("service_price_snapshot", {
		precision: 10,
		scale: 2,
	}).notNull(),
...
export const agendaBlocks = pgTable("agenda_blocks", {
	...
	reason: text("reason"),
	type: text("type", {
		enum: ["BLOCK_HOUR", "BLOCK_DAY", "BLOCK_PERIOD"],
	}).notNull(),
	createdAt: timestamp("created_at").defaultNow().notNull(),
	updatedAt: timestamp("updated_at")
		.defaultNow()
...
export const fixedExpenses = pgTable("fixed_expenses", {
	...
	type: text("type", { enum: ["FIXO", "VARIAVEL", "PARCELADO"] })
		.default("FIXO")
		.notNull(),
...
export const companySiteCustomizationsRelations = relations(
...
export const serviceResourcesRelations = relations(
	serviceResources,
	({ one }) => ({
...
export const googleCalendarConfigsRelations = relations(

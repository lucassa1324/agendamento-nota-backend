...
export const HomeSectionDTO = t.Object({
	heroBanner: t.Object({
		...
		appearance: t.Object({
			...
			verticalAlignment: t.Union([
				t.Literal("top"),
				t.Literal("center"),
				t.Literal("bottom"),
			]),
			horizontalAlignment: t.Union([
				t.Literal("left"),
				t.Literal("center"),
				t.Literal("right"),
			]),
			sectionHeight: t.Union([
				t.Literal("small"),
				t.Literal("medium"),
				t.Literal("full_screen"),
			]),
		}),
	}),
	...
	galleryPreview: t.Object({
		...
		displayLogic: t.Object({
			selectionMode: t.Union([
				t.Literal("automatic_recent"),
				t.Literal("manual_highlights"),
			]),
			photoCount: t.Union([
				t.Literal(3),
				t.Literal(6),
	...
	ctaSection: t.Object({
		...
		designConfig: t.Object({
			backgroundType: t.Union([
				t.Literal("solid_color"),
				t.Literal("gradient"),
				t.Literal("image"),
			]),

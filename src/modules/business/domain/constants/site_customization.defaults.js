export const DEFAULT_LAYOUT_GLOBAL = {
    header: {
        backgroundAndEffect: {
            color: "#ffffff",
            opacity: 0.95,
...
export const DEFAULT_HOME_SECTION = {
    heroBanner: {
        visibility: true,
        title: {
...
export const DEFAULT_GALLERY_SECTION = {
    gridConfig: {
        columns: 3,
        gap: "24px",
    },
...
export const DEFAULT_ABOUT_US_SECTION = {
    aboutBanner: {
        visibility: true,
        title: "Sobre Nós",
        backgroundImageUrl: "",
...
export const DEFAULT_APPOINTMENT_FLOW_SECTION = {
    colors: {
        primary: "#000000",
        secondary: "#333333",
        background: "#ffffff",
